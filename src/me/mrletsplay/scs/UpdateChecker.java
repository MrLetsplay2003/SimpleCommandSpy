...
public class UpdateChecker {
	...
	public static void sendUpdateMessage(Result r, Player... pls) {
		for(Player p : pls){
			p.sendMessage("§aThere's an update available for SimpleCommandSpy");
	...
	public static Result checkForUpdate(){
		try {
			URL updUrl = new URL("https://graphite-official.com/api/plugin-data/SimpleCommandSpy/version.txt");
